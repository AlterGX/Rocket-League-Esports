...
function TemplatesTwoPlayers() {
  ...
  const willicraft400Data: Player = {
    ...
    analysis: "Willicraft400 es el nexo perfecto entre defensa y ataque. Su inteligencia táctica le permite estar siempre en el lugar correcto. Francia depende de su visión de juego para mantener la presión constante sobre el rival.",
    mvpProbability: 82,
    championshipProbability: 85,
  };
  ...
  const skkart01Data: Player = {
    ...
    analysis: "Skkart01 es la definición de eficiencia frente a la portería. Su capacidad para encontrar huecos en defensas cerradas lo convierte en la principal amenaza ofensiva de Inglaterra.",
    mvpProbability: 80,
