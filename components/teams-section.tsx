...
const teams = [
  ...
  { id: 10, name: 'PXG', abbr: 'PX', group: 'B', players: ['El_Gangsta07'], logo: 'PX.png', description: 'París glamoroso buscando dominación europea.', rival: {name: 'Marseille', logo: 'MS.png'}, countryFlag: 'https://flagcdn.com/24x18/fr.png', leagueLogo: '/acces/ligue1.png', economicStatus: '€2.200.000.000M' },
